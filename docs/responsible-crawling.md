...
Optional team-website crawling (when enabled) should remain bounded (Nevada scope, low concurrency, respectful delays). Broader discovery research (social ownership confidence, Internet Archive, Onshape, school context) belongs in dedicated issues and must not introduce student profiling.
